...
using System.Text;
using InfoCheck.PatClass;
using InfoCheck.PatClass.Boost;

namespace PatClass.DecisionTree
{
    /// <summary>
    /// foamliu, 2008/01/12.
    ...
    public class ID3
    {
        ...
        public ID3(ExampleSet t_set, Vocabulary voc)
        {
            this.m_t_set = t_set;
            this.m_voc = voc;
        ...
        private double GetGain(string word)
        {
            ...
            // S = [700+, 700-]
            double numS = this.m_t_set.Examples.Count;
            ...
            foreach (TextExample example in m_t_set.Examples)
            {
